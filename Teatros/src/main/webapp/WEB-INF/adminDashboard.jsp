...
<%
    ...
    Integer cantObras = (Integer) request.getAttribute("cantObras");
    Integer cantClientes = (Integer) request.getAttribute("cantClientes");
    
    int obrasActivas = (cantObras != null) ? cantObras : 0;
    int clientesTotales = (cantClientes != null) ? cantClientes : 0;
%>
<!DOCTYPE html>
<html lang="es">
<head>
            ...
            <main class="col-md-10 px-md-4 py-4">
                ...
                <div class="row">
                    <div class="col-md-4 mb-4">
                        <a href="listaObras" class="card-link">
                    ...
                    <div class="col-md-4 mb-4">
                        <a href="listaUsuarios" class="card-link">
